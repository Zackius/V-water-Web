     ...
     return (
       <div className="bg-blue-200 h-full p-16">
         <div className="flex justify-evenly">
           ...
           <div>
             <img className=" w-[500px] h-[500px] rounded-2xl relative" src={isFocus ? Johnny : Water1} alt="johhnnt" onMouseEnter={handleMouseEnter}    onMouseLeave={handleMouseLeave}
  />
           </div>
         </div>
         <div className="flex justify-evenly">
         <div>
           <img className=" w-[500px] h-[500px] rounded-2xl  relative"  src={onSet ? Irrigation : Irrigation2} onMouseEnter={handMouse}    onMouseLeave={handMouseOff} alt="johhnnt"/>
           </div>
         ...
         <div className="w-[600px] h-auto flex-row justify-center pt-28  items-center" >
           ...
           <div>
           <img className=" w-[500px] h-[500px] rounded-2xl"  src={transition ? Water : Water2} onMouseEnter={trans}  onMouseLeave={transitions}  alt="johhnnt"/>
           </div>
         </div>
       </div>
     )
